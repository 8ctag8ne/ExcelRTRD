...
public interface ILabCalculatorListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterMminExpr([NotNull] LabCalculatorParser.MminExprContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>MminExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitMminExpr([NotNull] LabCalculatorParser.MminExprContext context);
	/// <summary>
	/// Enter a parse tree produced by the <c>MmaxExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterMmaxExpr([NotNull] LabCalculatorParser.MmaxExprContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>MmaxExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitMmaxExpr([NotNull] LabCalculatorParser.MmaxExprContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterArglist([NotNull] LabCalculatorParser.ArglistContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="LabCalculatorParser.arglist"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitArglist([NotNull] LabCalculatorParser.ArglistContext context);
}
